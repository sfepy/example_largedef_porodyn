...
project = u'sfepy_example_largedef_porodyn'
...
html_context = {
    ...
    'github_user': 'vlukes',
    'github_repo': 'example_largedef_porodyn',
    'menu_links_name': 'Connections',
    'menu_links': [
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/sfepy/example_largedef_porodyn'),
        ('<i class="fa fa-file-text fa-fw"></i> The Paper', 'https://doi.org/10.1016/j.advengsoft.2016.11.003'),
...
htmlhelp_basename = 'example_largedef_porodyn'
